...
- (void)requestAttention{//关注此人
    NSDictionary * pragram = @{@"device_id":[JWTools getUUID],@"token":[UserSession instance].token,@"user_id":@([UserSession instance].uid),@"attention_id":self.model.userid,@"auser_type":self.model.user_type,@"user_type":@([UserSession instance].isVIP==3?2:1)};
